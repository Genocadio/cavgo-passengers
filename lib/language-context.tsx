...
const translations = {
  en: {
    // Header
    appName: "CAVGO",
    tagline: "Borderless mobilities start here",
    signIn: "Sign In",
    signOut: "Sign Out",
    ...
    companyPlaceholder: "Type a company's name…",
    ...
    // Route Cards
    seatsAvailable: "Remaining seats",
    bookNow: "Book Now",
    ...
    ruralRouteProgress: "Provincial route in progress: Unlimited booking options available",
    timeTBD: "Time TBD",

    // Booking Modal
    bookYourJourney: "Start your own booking",
    journeyDetails: "Journey Details",
    selectOrigin: "Select your origin bus stop",
    selectDestination: "Select your dropping bus stop",
    ...
    paymentPrompt: "Payment is being processed via Mobile Money. Be ready to pay on this number.",
    registeredPhoneNote: "Pay with another telephone number, if you have a minimum money balance. Change it above",
    ...
    routes: "routes",
    routesIn: "routes in",
    footer: "Making mobility accessible for everyone.",
  },
  rw: {
    // Header
    appName: "CAVGO",
